            ...
            <v-card class="card--flex-toolbar">
              <v-toolbar card prominent class="green lighten-4 elevation-1">
                <v-avatar v-if="list.list.owner.profilePicture" class="elevation-3" size="100">
                  <v-img
                    :src="`${pictureApiUrl}${list.list.owner.profilePicture}`"
                  />
                </v-avatar>
              ...
              <v-card-text>
                  ...
                  <v-flex xs12>
                    ...
                    <p
                      v-if="list.list.updatedAt"
                      class="body-2"
                    >Updated on {{ list.list.updatedAt | moment }}</p>
                    ...
                    <p
                      v-if="list.list.picker"
                      class="body-2"
                    >When? {{ list.list.pickedAt | moment }}</p>
                    <p
                    ...
                    <p
                      ...
                      class="body-2"
                    >When? {{ list.list.deliveredAt | moment }}</p>
                    <p
                      v-if="list.list.confirmedAt"
                      class="body-2"
                    ...
                    <p
                      v-if="list.list.confirmedAt"
                      class="body-2"
                    >When? {{ list.list.confirmedAt | moment }}</p>
                    <v-divider class="pb-2"/>
                  </v-flex>
                </v-layout>
                <v-layout align-center pa-4 row>
                  ...
                  <v-flex xs6>
                    <v-img
                      max-width="150"
                      max-height="50"
                      :src="getSelectedStore(list.list.storeId)"
                    ></v-img>
                  </v-flex>
                </v-layout>
                <v-divider/>
